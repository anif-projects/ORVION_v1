  ...
  return (
    <motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit" className="max-w-2xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Configure SMTP credentials, Cloudinary video presets, and Payment provider strategy.</p>
      </div>
      ...
      <form onSubmit={handleSave} className="glass-panel p-8 rounded-3xl border border-slate-200/80 dark:border-slate-800/80 space-y-6">
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">Cloudinary Public API Key</label>
            <input
              type="text"
